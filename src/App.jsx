...
// Simple SVG icons
const WindIcon = () => (
  <svg viewBox="0 0 24 24" width="24" height="24" stroke="#777" strokeWidth="2" fill="none">
        ...
        <div className="sidebar">
          ...
          <div className="hourly-forecast">
            ...
            <div className="hourly-grid">
              ...
              {/* Extra hourly items for ultrawide displays */}
              <div className="hour-item ultrawide-only">
              ...
              <div className="hour-item ultrawide-only">
                ...
                <div className="hour-temp">19°</div>
                <div className="hour-condition">Partly Cloudy</div>
              </div>
            </div>
          </div>
        </div>
